...
public class StatusPanel extends JPanel {
    ...
    public StatusPanel() {
        ...
        statusLine = new JLabel("Reversi started!");
        this.add(statusLine, BorderLayout.CENTER);

        statusLineServer = new JPanel();
        statusLineServer.setBorder(BorderFactory.createLineBorder(Color.gray,3));
        statusLine.setBackground(Color.gray);
        this.add(statusLineServer, BorderLayout.WEST);
    ...
    public void setRemoteServerOnNotConnected() {
        statusLineServer.setBorder(BorderFactory.createLineBorder(Color.green,3));
        statusLineServer.setBackground(Color.gray);
    }

    public void setRemoteServerOnConnected() {
        statusLineServer.setBorder(BorderFactory.createLineBorder(Color.green,3));
        statusLineServer.setBackground(Color.red);
    }

    public void setRemoteServerOff() {
        statusLineServer.setBorder(BorderFactory.createLineBorder(Color.gray,3));
        statusLineServer.setBackground(Color.gray);
    }
