...
public abstract class AbstractPlayer extends ModelObservable implements Player, Observer {
    ...
    private final PlayerStatusController _playerStatus = new PlayerStatusController(Player.WAITING);
     ...
     * @param color
     */
    protected AbstractPlayer(Game game, String name, ReversiColor color) {
        this._game = game;
        this._name = name;
        this._color = color;
     ...
     * @param color
     */
    protected AbstractPlayer(String name, ReversiColor color) {
        this._name = name;
        this._color = color;
        this._game = null;
        _playerStatus.setInterruptState(Player.STOPPED);
