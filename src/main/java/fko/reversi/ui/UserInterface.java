...
import fko.reversi.mvc.ModelObserver;

/**
 * <p>An interface for user interface used with ReversiByFrankKopp.
 * The interface has currently no fields or methods but extends the
 * java.util.Observer via the ModelObserver interface.</p>
 */
